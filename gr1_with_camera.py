...
def main():
    ...
    camera.set_focal_length(1.815) # smaller => wider range of view
    ...
    table.set_world_poses(positions=np.array([[0.5,0,0]]),
    ...
    for step in range(10000):
        ...
        gr1_articulation_controller.apply_action(ArticulationAction(joint_positions=np.zeros_like(current_joint_positions)))
